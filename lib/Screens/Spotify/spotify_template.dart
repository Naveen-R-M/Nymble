...
import 'package:nymble/Components/sized_icon.dart';
...
class SpotifyTemplate extends StatefulWidget {
  @override
  _SpotifyTemplateState createState() => _SpotifyTemplateState();
}

class _SpotifyTemplateState extends State<SpotifyTemplate> {
  bool _loading = false;
